...
const CommentCaMarche = () => {
  const sellerSteps = [
    ...
    },
    {
      ...
      description: "Remettez l'article et gardez 100% du prix. Vide Vaisselle ne prend AUCUNE commission sur la vente !",
    },
  ];
      ...
      <section className="hero-gradient py-16 md:py-24">
        <div className="container text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-lg text-muted-foreground">
            Sur Vide Vaisselle, la vente est 100% gratuite. Gagnez en visibilité en boostant
